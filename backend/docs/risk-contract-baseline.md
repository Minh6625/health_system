...
| Field | Value |
| --- | --- |
| Baseline version | `v1.5` (Phase 4A-full slice 3a + 3b — simulator sleep dispatch + mobile risk-type filter) |
| Wire version | `0.5.0` (unchanged — new ``risk_type`` query param is optional + forward-compatible) |
| Captured from branch | `feat/risk-core-phase4a-mobile-sleep-filter` |
